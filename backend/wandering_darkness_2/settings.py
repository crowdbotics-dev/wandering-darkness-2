"""
Django settings for wandering_darkness_2 project.
...
ROOT_URLCONF = 'wandering_darkness_2.urls'
...
WSGI_APPLICATION = 'wandering_darkness_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wandering_darkness_2 API",
    "DESCRIPTION": "API documentation for wandering_darkness_2 App",
    "VERSION": "v1",
}
